...
.next16	;$587e
	...
	pop af
	ld [hl],a
	; DV Ball and Shiny Ball code by ShantyTown begins here
	; LUXURY_BALL sets the DVs to max
    ld a,[$cf91]
    cp LUXURY_BALL
    jr nz, .skipDVBall
    ld a,$ff
...
.noCarry2
	...
	cp a,250 ; is there already at least 64000 (640 * 100 or 256 * 250) stat experience?
	jr nc,.vitaminNoEffect ; if so, vitamins can't add any more
	add b ; add 6400 (640 * 10 or 256 * 25) stat experience
