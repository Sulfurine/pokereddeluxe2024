...
.evilTrainerListLoop
	...
	jr .PlaySound
.noEvilTrainer
	ld hl, PokemaniacTrainerList
.PokemaniacTrainerListLoop
	ld a, [hli]
	cp $ff
	jr z, .noPokemaniacTrainer
	cp b
	jr nz, .PokemaniacTrainerListLoop
	ld a, MUSIC_MEET_POKEMANIAC
	jr .PlaySound
.noPokemaniacTrainer
	ld hl, BeautyTrainerList
.BeautyTrainerListLoop
	ld a, [hli]
	cp $ff
	jr z, .noBeautyTrainer
	cp b
	jr nz, .BeautyTrainerListLoop
	ld a, MUSIC_MEET_BEAUTY
	jr .PlaySound
.noBeautyTrainer
	ld hl, JrTrainerList
.JrTrainerListLoop
	...
	jr z, .noJrTrainer
	cp b
	jr nz, .JrTrainerListLoop
	ld a, MUSIC_MEET_JRTRAINER
	jr .PlaySound
.noJrTrainer
...
GetTrainerInformation:: ; 3566 (0:3566)
	...
	and a
	jr nz, .linkBattle
	ld a, Bank(TrainerPicAndMoneyPointers2)
	call BankswitchHome
	ld a, [W_TRAINERCLASS] ; wd031
	dec a
	ld hl, TrainerPicAndMoneyPointers2
	ld bc, $5
	call AddNTimes
	ld de, wd033
	ld a, [hli]
...
LoadHpBarAndStatusTilePatterns::	
	...
	ld hl,vChars2 + $620
	lx bc,BANK(HpBarAndStatusGraphics), (HpBarAndStatusGraphicsEnd - HpBarAndStatusGraphics) / $10
	call GoodCopyVideoData
	ld de,EXPBarGraphics
	ld hl,vChars1 + $400
	lx bc,BANK(EXPBarGraphics), (EXPBarGraphicsEnd - EXPBarGraphics) / $10
