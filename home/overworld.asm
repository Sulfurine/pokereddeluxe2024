...
.moveAhead2
	...
	jr nz,.normalPlayerSpriteAdvancement
	callba BikeSpeedup ; if riding a bike and not jumping a ledge
	callba BikeSpeedup ; added
	callba BikeSpeedup ; added
	jr .notRunning
; Running Shoes and Surfing at bike speed (Mateo)
...
.surfFaster
	callba BikeSpeedup ; Make you go faster if you were holding B
